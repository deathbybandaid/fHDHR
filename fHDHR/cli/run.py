...
def build_args_parser():
    ...
    parser.add_argument('--iliketobreakthings', dest='iliketobreakthings', type=str, nargs='?', const=False, required=False, default=False, help='Override Config Settings not meant to be overridden.')
